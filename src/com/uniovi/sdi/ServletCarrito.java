...
public class ServletCarrito extends HttpServlet {
	...
	/**
	 * 
	 * Obtenemos el carrito guardado en sesión.Si no hay carrito, se trata de un nuevo usuario
	 * entonces instanciamos un nuevo carrito y lo insertamos en sesión.
	 * 
